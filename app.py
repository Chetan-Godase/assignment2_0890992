...
def list_files():
    """
        http://127.0.0.1:8080/list_files?bucket_name=comp4312_0890992
    """
    try:
        bucket_name = request.args.get('bucket_name', default='comp4312_0890992', type=str)
...
def create_bk():
    """
        http://127.0.0.1:8080/create_bk?bucket_name=comp4312_0890992
    """
    try:
        bucket_name = request.args.get('bucket_name', default='comp4312_0890992')
...
def delete_bk():
    """
        http://127.0.0.1:8080/delete_bk?bucket_name=comp4312_0890992
    """
    try:
        bucket_name = request.args.get('bucket_name', default='comp4312_0890992')
        #####################
